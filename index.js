...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.nsh6goc.mongodb.net/?retryWrites=true&w=majority`;
...
async function run() {
  try {
    ...
    const ArtCraftStore = client.db('artCraft');
    const productsCollection = ArtCraftStore.collection('products');
    const addToCartCollection = ArtCraftStore.collection('carts');
